/* DONE ALREADY 2: Bind the HEADER and the SECTION elements above to variables */
const header = document.querySelector("header");
const section = document.querySelector("section");

// DONE 3a: Create the asynchronous function populate()
//? async allows for "await" to be used
async function populate() {
    ...
    let url = "https://zechsvariety.github.io/Client-Side-Javascript/lesson-10/js/i-scream.json";
    ...
    //? await waits until it recieves the response
...
// DONE 3b: Call the populate() function
populate();
    
/* DONE 9b: Build out the populateHeader() function */
function populateHeader(json) {
    ...
    para.textContent = `Head Office: ${json.headOffice}, est. ${json.established}`;
...
function showTopFlavours(json){
    ...
    for (let i = 0; i < topFlavours.length; i++) {
        ...
        //rating
        p3.textContent = `Rating: ${topFlavours[i].rating} / 5`;
